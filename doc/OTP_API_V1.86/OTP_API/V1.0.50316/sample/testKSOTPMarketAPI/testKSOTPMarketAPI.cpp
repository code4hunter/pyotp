...
public:
	...
	// get trading day
		...
		// 行情订阅列表
		CKSOTPSpecificInstrumentField *ppInstrumentID[1]= {0};
        ppInstrumentID[0] = new CKSOTPSpecificInstrumentField;
		strcpy(ppInstrumentID[0]->ExchangeID,m_chExchangeID);
		strcpy(ppInstrumentID[0]->InstrumentID,m_chContract);
		// 行情订阅个数
		int iInstrumentID = 1;
        // 	订阅
