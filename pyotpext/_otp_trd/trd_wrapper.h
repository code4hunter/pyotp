...
public:
	...
	virtual void OnRspQryInstrumentMarginRate(CKSOTPInstrumentMarginRateField *pInstrumentMarginRate, CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (pInstrumentMarginRate)
		{
			...
			PyDict_SetItemString(dict, "InvestorRange", Py_BuildValue("c", pInstrumentMarginRate->InvestorRange));
	...
	virtual void OnRspQryOTPInsCommRate(CKSOTPOTPInsCommRateField *pOTPInsCommRate, CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
	{
		...
		if (pOTPInsCommRate)
		{
			PyDict_SetItemString(dict, "InstrumentID", Py_BuildValue("s", pOTPInsCommRate->InstrumentID));
			PyDict_SetItemString(dict, "InvestorRange", Py_BuildValue("c", pOTPInsCommRate->InvestorRange));
			PyDict_SetItemString(dict, "BrokerID", Py_BuildValue("s", pOTPInsCommRate->BrokerID));
			PyDict_SetItemString(dict, "InvestorID", Py_BuildValue("s", pOTPInsCommRate->InvestorID));
			PyDict_SetItemString(dict, "OpenRatioByMoney", Py_BuildValue("d", pOTPInsCommRate->OpenRatioByMoney));
			PyDict_SetItemString(dict, "OpenRatioByVolume", Py_BuildValue("d", pOTPInsCommRate->OpenRatioByVolume));
			PyDict_SetItemString(dict, "CloseRatioByMoney", Py_BuildValue("d", pOTPInsCommRate->CloseRatioByMoney));
			PyDict_SetItemString(dict, "CloseRatioByVolume", Py_BuildValue("d", pOTPInsCommRate->CloseRatioByVolume));
			PyDict_SetItemString(dict, "CloseTodayRatioByMoney", Py_BuildValue("d", pOTPInsCommRate->CloseTodayRatioByMoney));
			PyDict_SetItemString(dict, "CloseTodayRatioByVolume", Py_BuildValue("d", pOTPInsCommRate->CloseTodayRatioByVolume));
			PyDict_SetItemString(dict, "StrikeRatioByMoney", Py_BuildValue("d", pOTPInsCommRate->StrikeRatioByMoney));
			PyDict_SetItemString(dict, "StrikeRatioByVolume", Py_BuildValue("d", pOTPInsCommRate->StrikeRatioByVolume));
			PyDict_SetItemString(dict, "ExchangeID", Py_BuildValue("s", pOTPInsCommRate->ExchangeID));
		}
		if (!PyObject_CallMethod(_spi, (char*)"on_rsp_qry_otp_ins_comm_rate", (char*)"Nisib", dict,
			pRspInfo->ErrorID, pRspInfo->ErrorMsg, nRequestID, bIsLast))
		{
			PyErr_Print();
		}
